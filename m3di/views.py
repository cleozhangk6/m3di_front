...
def main_UniVar(request):
    if request.method == "GET":
        ...
        # interactors = Stringinteractions.objects.raw('''
        # SELECT id, uniprot_id FROM BasicInfo2 WHERE uniprot_id = %s
        # UNION
        # (SELECT b.id, b.uniprot_id FROM StringInteractions as s
