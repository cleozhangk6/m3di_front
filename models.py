...
class Pfam(models.Model):
    uniprot_id = models.CharField(max_length=10, blank=True, null=True)
    ali_s = models.IntegerField(blank=True, null=True)
    ali_e = models.IntegerField(blank=True, null=True)
    pfam_id = models.CharField(max_length=10, blank=True, null=True)
    pfam_name = models.TextField(blank=True, null=True)
    tyype = models.TextField(blank=True, null=True)
    e_value = models.CharField(max_length=20, blank=True, null=True)
    clan = models.TextField(blank=True, null=True)
